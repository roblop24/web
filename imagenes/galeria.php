 ...
 if ($included && $inline && array_key_exists('pic', $_REQUEST)) {
  ...
  if (sizeof($dirs) > 0 && $subdirs) {
   ...
   foreach ($dirs as $filename) {
    ...
    if ($target == '') {
     $url = preg_replace("/^([^?]+).*$/i", "\1/i", $_SERVER['REQUEST_URI']);
     if (!empty($urlsuffix)) {
...
?>
<a href="http://mecasohoy.tk/web/nuevo.php"><img title="Volver a subir" width='62' height='25'src="../images/atras.jpg" alt="Volger a subir" align:right ></a> 
<a href="http://mecasohoy.tk/web/galeria.php?dir=%2F"><img title="Volver a subir" width='62' height='25'src="../images/inicio.jpg" alt="Volger a subir" align:right ></a> 
