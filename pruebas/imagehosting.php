...
$varallw = array("image/bmp","image/gif","image/jpeg","image/pjpeg","image/png","image/x-png","image/3gp","video/mp4");
...
<p align="center"><img src="../../imagenes/subidas/<?php echo $varname; ?>"></p>

<?php } ?>

<?php if ($_GET['image'] != "") { ?>

<p align="center"><img src="../..imagenes/subidas/<?php echo $_GET['image']; ?>"></p>
